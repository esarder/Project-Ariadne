    ...
    while(true){
        ...
        switch(input){
            case 1: //add user
                ...
                cout << "Last name: ";
                cin >> lastName;
                cout << "Enter emergency contact's email address: ";
                cin >> ECemail;
                cout << "Enter emergency contact's first name: ";
                cin >> ECfn;
                cout << "Enter emergency contact's last name: ";
                cin >> ECln;
                cout << "Enter a 4 digit pin for disabling emergency alerts: ";
                cin >> tempPin;
            ...
            case 2: //add an event
              ...
              cin >> event;
              cout << "Enter countdown time for alert (in seconds): ";
              cin >> timer;
            ...
            case 8://read in user and event data
                if(first == false){
                  ...
                  while(getline(myfile, line)){
                    ...
                    getline(linestream, _time);
                    int int_time = stoi(_time);
